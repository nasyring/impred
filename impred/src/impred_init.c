...
extern SEXP impred_IMTS_mh_sampler(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP impred_IMTS_mh_sampler2(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"impred_plaus_two_stage_full", (DL_FUNC) &impred_plaus_two_stage_full, 7},
   {"impred_IMTS_mh_sampler", (DL_FUNC) &impred_IMTS_mh_sampler, 9},
     {"impred_IMTS_mh_sampler2", (DL_FUNC) &impred_IMTS_mh_sampler2, 10},
  {NULL, NULL, 0}
};
